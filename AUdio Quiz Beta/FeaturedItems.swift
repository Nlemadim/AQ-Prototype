...
enum FeaturedQuiz: Quiz {
    ...
    var questions:  [Question] {
        ...
        case .gmats:
            return [
//                Question(id: UUID(), questionContent: "If x and y are positive, is x > y?", questionNote: "", topic: "Quantitative Reasoning", options: ["x^2 > y^2", "square root of x > square root of y", "Both A and B",  Neither A nor B"], correctOption: "C", selectedOption: "", isAnswered: false, isAnsweredCorrectly: false, numberOfPresentations: 0, questionAudio: "", questionNoteAudio: "")
...
//                Question(id: UUID(), questionContent: "What is the area of a circle with a radius of 3?", questionNote: "", topic: "Quantitative Reasoning", options: ["\(6\pi\)", "\(9\pi\)", "\(12\pi\)", "\(18\pi\)"], correctOption: "B", selectedOption: "", isAnswered: false, isAnsweredCorrectly: false, numberOfPresentations: 0, questionAudio: "", questionNoteAudio: "")
